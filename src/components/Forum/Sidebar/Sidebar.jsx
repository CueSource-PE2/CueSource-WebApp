...
function Sidebar() {
    return (
        <>
        <div className='w-fit h-full py-5 px-2 rounded-md bg-zinc-700 bg-opacity-75 flex flex-col justify-between items-center'>
            ...
            <div className='absolute top-[80%] left-7 flex flex-col justify-center items-center gap-3'>
                <p className="text-white text-sm font-normal font-['Open Sans']">The adventure awaits you!!</p>
