...
function Navbar() {
    return (
        <div className='flex justify-between items-center mx-8 mt-3 mb-5'>
                ...
                <NavLink to='/'><div className=' border-2 border-green-700 rounded-md bg-white px-5 py-1 font-semibold text-green-700 cursor-pointer hover:scale-[102%] transition duration-300 ease-in-out hover:bg-green-700 hover:text-white active:scale-95'>Home</div></NavLink>            
        </div>
    )
}
